 ...
 * 
 * @svn			$Id: SimplePageAsDefaultPageLocationListener.class.php 1615 2010-08-30 10:59:11Z TobiasH87 $
 * @package		de.community4wcf.wcf.page.simplepage
 * @author		WoltLab Community , (adapted for simplepage by) TobiasH
 * @copyright	2010 WoltLab Community
 * @license		LGPL <http://www.gnu.org/licenses/lgpl.html>
 */
 
class SimplePageAsDefaultPageLocationListener implements EventListener {
	/**
	...
	public function execute($eventObj, $className, $eventName) {
		if (MODULE_SIMPLEPAGE && SIMPLEPAGE_ENABLE_STARTPAGE && $eventObj->session->getUser()->getPermission('user.managepages.canViewSimplePage')) {
