 ...
 * 
 * @svn			$Id: HeaderOverrideForSimplePageAsWikiDefaultPageLocationListener.class.php 1613 2010-08-29 18:20:41Z TobiasH87 $
...
class HeaderOverrideForSimplePageAsWikiDefaultPageLocationListener implements EventListener {
	/**
	...
	public function execute($eventObj, $className, $eventName) {
		if (MODULE_SIMPLEPAGE && SIMPLEPAGE_ENABLE_STARTPAGE_WIKI_LOGO && WCF::getUser()->getPermission('user.managepages.canViewSimplePage')) {
