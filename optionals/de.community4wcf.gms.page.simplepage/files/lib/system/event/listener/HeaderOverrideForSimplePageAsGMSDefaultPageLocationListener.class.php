 ...
 * 
 * @svn			$Id: HeaderOverrideForSimplePageAsGMSDefaultPageLocationListener.class.php 1613 2010-08-29 18:20:41Z TobiasH87 $
...
class HeaderOverrideForSimplePageAsGMSDefaultPageLocationListener implements EventListener {
	/**
	...
	public function execute($eventObj, $className, $eventName) {
		if (MODULE_SIMPLEPAGE && SIMPLEPAGE_ENABLE_STARTPAGE_GMS_LOGO && WCF::getUser()->getPermission('user.managepages.canViewSimplePage')) {
