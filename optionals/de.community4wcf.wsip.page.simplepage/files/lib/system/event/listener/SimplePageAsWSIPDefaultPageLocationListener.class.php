 ...
 * 
 * @svn			$Id: SimplePageAsWSIPDefaultPageLocationListener.class.php 1615 2010-08-30 10:59:11Z TobiasH87 $
...
class SimplePageAsWSIPDefaultPageLocationListener implements EventListener {
	/**
	...
	public function execute($eventObj, $className, $eventName) {
		if (MODULE_SIMPLEPAGE && SIMPLEPAGE_ENABLE_STARTPAGE_WSIP && $eventObj->session->getUser()->getPermission('user.managepages.canViewSimplePage') && !SIMPLEPAGE_ENABLE_STARTPAGE) {
